...
" Last Updated: Tue 19 Sep 2023 12:05:37 AM EDT
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#252525', '#ed4a46', '#70b433', '#dbb32d', '#368aeb', '#eb6eb7', '#3fc5b7', '#777777', '#3b3b3b', '#ff5e56', '#83c746', '#efc541', '#4f9cfe', '#ff81ca', '#56d8c9', '#dedede']
  endif
  if has('nvim')
  ...
  hi Normal guifg=#b9b9b9 guibg=#181818 gui=NONE cterm=NONE
  hi IncSearch guifg=#e67f43 guibg=NONE gui=reverse cterm=reverse
  hi Search guifg=#dbb32d guibg=NONE gui=reverse cterm=reverse
  hi! link QuickFixLine Search
  hi Visual guifg=NONE guibg=#3b3b3b gui=NONE cterm=NONE
  hi MatchParen guifg=#efc541 guibg=#3b3b3b gui=bold cterm=bold
  ...
  hi Folded guifg=NONE guibg=#252525 gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#3b3b3b gui=NONE cterm=NONE
  hi LineNr guifg=#777777 guibg=#252525 gui=NONE cterm=NONE
  hi CursorLineNr guifg=#dedede guibg=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#777777 guibg=#777777 gui=NONE cterm=NONE
  hi StatusLine guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi StatusLineNC guifg=NONE guibg=#3b3b3b gui=NONE cterm=NONE
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi TabLineSel guifg=#dedede guibg=#252525 gui=bold,reverse cterm=bold,reverse
  hi TabLine guifg=#777777 guibg=NONE gui=reverse cterm=reverse
  hi TabLineFill guifg=#777777 guibg=NONE gui=reverse cterm=reverse
  hi ToolbarButton guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi ToolbarLine guifg=NONE guibg=#3b3b3b gui=NONE cterm=NONE
  hi Pmenu guifg=#777777 guibg=#252525 gui=NONE cterm=NONE
  hi PmenuSel guifg=NONE guibg=#3b3b3b gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#777777 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#3b3b3b gui=NONE cterm=NONE
  hi DiffAdd guifg=#70b433 guibg=#252525 gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#252525 gui=NONE cterm=NONE
  hi DiffDelete guifg=#ed4a46 guibg=#252525 gui=NONE cterm=NONE
  hi DiffText guifg=#252525 guibg=#dbb32d gui=NONE cterm=NONE
  hi DiagnosticError guifg=#ed4a46 guibg=#252525 gui=NONE cterm=NONE
  hi DiagnosticWarn guifg=#e67f43 guibg=#252525 gui=NONE cterm=NONE
  hi DiagnosticInfo guifg=#4f9cfe guibg=#252525 gui=NONE cterm=NONE
  hi DiagnosticHint guifg=#777777 guibg=#252525 gui=NONE cterm=NONE
  hi DiagnosticOk guifg=#83c746 guibg=#252525 gui=NONE cterm=NONE
  hi DiagnosticUnderlineError guifg=#b9b9b9 guibg=#181818 guisp=#ed4a46 gui=underline cterm=underline
  hi DiagnosticUnderlineWarn guifg=#b9b9b9 guibg=#181818 guisp=#e67f43 gui=underline cterm=underline
  hi DiagnosticUnderlineInfo guifg=#b9b9b9 guibg=#181818 guisp=#4f9cfe gui=underline cterm=underline
  hi DiagnosticUnderlineHint guifg=#b9b9b9 guibg=#181818 guisp=#777777 gui=underline cterm=underline
  hi DiagnosticUnderlineOk guifg=#b9b9b9 guibg=#181818 guisp=#83c746 gui=underline cterm=underline
  hi DiagnosticDeprecated guifg=#b9b9b9 guibg=#181818 guisp=#ed4a46 gui=strikethrough cterm=strikethrough
  hi Comment guifg=#777777 guibg=NONE gui=italic cterm=italic
  hi Constant guifg=#3fc5b7 guibg=NONE gui=NONE cterm=NONE
  hi! link String Constant
  hi! link Number Constant
  hi! link Boolean Constant
  hi! link Character Constant
  hi! link Float Constant
  hi Identifier guifg=#4f9cfe guibg=NONE gui=NONE cterm=NONE
  hi! link Function Identifier
  hi Statement guifg=#efc541 guibg=NONE gui=NONE cterm=NONE
  ...
  hi PreProc guifg=#e67f43 guibg=NONE gui=NONE cterm=NONE
  hi! link Define PreProc
  hi! link PreCondit PreProc
  hi! link Include PreProc
  hi! link Macro Include
  hi Type guifg=#70b433 guibg=NONE gui=NONE cterm=NONE
  hi! link Typedef Type
  hi! link StorageClass Type
  hi! link Structure Type
  hi Special guifg=#ed4a46 guibg=NONE gui=NONE cterm=NONE
  hi! link SpecialChar Special
  hi! link Delimiter Special
  hi! link SpecialComment Special
  hi! link Debug Special
  hi! link Tag Special
  hi Error guifg=#ed4a46 guibg=NONE gui=bold cterm=bold
  hi Todo guifg=#eb6eb7 guibg=NONE gui=bold cterm=bold
  hi Underlined guifg=#a580e2 guibg=NONE gui=underline cterm=underline
  hi Ignore guifg=#3b3b3b guibg=NONE gui=NONE cterm=NONE
  hi VimCommand guifg=#dbb32d guibg=NONE gui=NONE cterm=NONE
  hi RubyDefine guifg=#dedede guibg=NONE gui=bold cterm=bold
  if !s:italics
    hi Comment gui=NONE cterm=NONE
  endif
  if get(g:, 'selenized_green_keywords', 0)
    hi Statement guifg=#70b433 guibg=NONE gui=NONE cterm=NONE
  ...
  hi SpellBad guifg=NONE guibg=NONE guisp=#ed4a46 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi SpellCap guifg=NONE guibg=NONE guisp=#ed4a46 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi SpellLocal guifg=NONE guibg=NONE guisp=#dbb32d gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi SpellRare guifg=NONE guibg=NONE guisp=#3fc5b7 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#ebebeb', '#d6000c', '#1d9700', '#c49700', '#0064e4', '#dd0f9d', '#00ad9c', '#878787', '#cdcdcd', '#bf0000', '#008400', '#af8500', '#0054cf', '#c7008b', '#009a8a', '#282828']
  endif
  if has('nvim')
  ...
  hi Normal guifg=#474747 guibg=#ffffff gui=NONE cterm=NONE
  hi IncSearch guifg=#d04a00 guibg=NONE gui=reverse cterm=reverse
  hi Search guifg=#c49700 guibg=NONE gui=reverse cterm=reverse
  hi! link QuickFixLine Search
  hi Visual guifg=NONE guibg=#cdcdcd gui=NONE cterm=NONE
  hi MatchParen guifg=#af8500 guibg=#cdcdcd gui=bold cterm=bold
  hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi! link lCursor Cursor
  hi CursorLine guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
  hi CursorColumn guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
  hi Folded guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#cdcdcd gui=NONE cterm=NONE
  hi LineNr guifg=#878787 guibg=#ebebeb gui=NONE cterm=NONE
  hi CursorLineNr guifg=#282828 guibg=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#878787 guibg=#878787 gui=NONE cterm=NONE
  hi StatusLine guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi StatusLineNC guifg=NONE guibg=#cdcdcd gui=NONE cterm=NONE
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi TabLineSel guifg=#282828 guibg=#ebebeb gui=bold,reverse cterm=bold,reverse
  hi TabLine guifg=#878787 guibg=NONE gui=reverse cterm=reverse
  hi TabLineFill guifg=#878787 guibg=NONE gui=reverse cterm=reverse
  hi ToolbarButton guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi ToolbarLine guifg=NONE guibg=#cdcdcd gui=NONE cterm=NONE
  hi Pmenu guifg=#878787 guibg=#ebebeb gui=NONE cterm=NONE
  hi PmenuSel guifg=NONE guibg=#cdcdcd gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#878787 gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#cdcdcd gui=NONE cterm=NONE
  hi DiffAdd guifg=#1d9700 guibg=#ebebeb gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#ebebeb gui=NONE cterm=NONE
  hi DiffDelete guifg=#d6000c guibg=#ebebeb gui=NONE cterm=NONE
  hi DiffText guifg=#ebebeb guibg=#c49700 gui=NONE cterm=NONE
  hi DiagnosticError guifg=#d6000c guibg=#ebebeb gui=NONE cterm=NONE
  hi DiagnosticWarn guifg=#d04a00 guibg=#ebebeb gui=NONE cterm=NONE
  hi DiagnosticInfo guifg=#0054cf guibg=#ebebeb gui=NONE cterm=NONE
  hi DiagnosticHint guifg=#878787 guibg=#ebebeb gui=NONE cterm=NONE
  hi DiagnosticOk guifg=#008400 guibg=#ebebeb gui=NONE cterm=NONE
  hi DiagnosticUnderlineError guifg=#474747 guibg=#ffffff guisp=#d6000c gui=underline cterm=underline
  hi DiagnosticUnderlineWarn guifg=#474747 guibg=#ffffff guisp=#d04a00 gui=underline cterm=underline
  hi DiagnosticUnderlineInfo guifg=#474747 guibg=#ffffff guisp=#0054cf gui=underline cterm=underline
  hi DiagnosticUnderlineHint guifg=#474747 guibg=#ffffff guisp=#878787 gui=underline cterm=underline
  hi DiagnosticUnderlineOk guifg=#474747 guibg=#ffffff guisp=#008400 gui=underline cterm=underline
  hi DiagnosticDeprecated guifg=#474747 guibg=#ffffff guisp=#d6000c gui=strikethrough cterm=strikethrough
  hi Comment guifg=#878787 guibg=NONE gui=italic cterm=italic
  hi Constant guifg=#00ad9c guibg=NONE gui=NONE cterm=NONE
  hi! link String Constant
  hi! link Number Constant
  hi! link Boolean Constant
  hi! link Character Constant
  hi! link Float Constant
  hi Identifier guifg=#0054cf guibg=NONE gui=NONE cterm=NONE
  hi! link Function Identifier
  hi Statement guifg=#af8500 guibg=NONE gui=NONE cterm=NONE
  hi! link Conditional Statement
  hi! link Repeat Statement
  hi! link Keyword Statement
  hi! link Label Statement
  hi! link Exception Statement
  hi! link Operator Statement
  hi PreProc guifg=#d04a00 guibg=NONE gui=NONE cterm=NONE
  hi! link Define PreProc
  hi! link PreCondit PreProc
  hi! link Include PreProc
  hi! link Macro Include
  hi Type guifg=#1d9700 guibg=NONE gui=NONE cterm=NONE
  hi! link Typedef Type
  hi! link StorageClass Type
  hi! link Structure Type
  hi Special guifg=#d6000c guibg=NONE gui=NONE cterm=NONE
  hi! link SpecialChar Special
  hi! link Delimiter Special
  hi! link SpecialComment Special
  hi! link Debug Special
  hi! link Tag Special
  hi Error guifg=#d6000c guibg=NONE gui=bold cterm=bold
  hi Todo guifg=#dd0f9d guibg=NONE gui=bold cterm=bold
  hi Underlined guifg=#7f51d6 guibg=NONE gui=underline cterm=underline
  hi Ignore guifg=#cdcdcd guibg=NONE gui=NONE cterm=NONE
  hi VimCommand guifg=#c49700 guibg=NONE gui=NONE cterm=NONE
  hi RubyDefine guifg=#282828 guibg=NONE gui=bold cterm=bold
  if !s:italics
    hi Comment gui=NONE cterm=NONE
  endif
  if get(g:, 'selenized_green_keywords', 0)
    hi Statement guifg=#1d9700 guibg=NONE gui=NONE cterm=NONE
    hi Type guifg=#c49700 guibg=NONE gui=NONE cterm=NONE
  endif
  hi Terminal guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Conceal guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Directory guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  ...
  hi SignColumn guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi SpecialKey guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi SpellBad guifg=NONE guibg=NONE guisp=#d6000c gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi SpellCap guifg=NONE guibg=NONE guisp=#d6000c gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi SpellLocal guifg=NONE guibg=NONE guisp=#c49700 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi SpellRare guifg=NONE guibg=NONE guisp=#00ad9c gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  hi Title guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi VisualNOS guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi WarningMsg guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi WildMenu guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi DiagnosticError ctermfg=203 ctermbg=235 cterm=NONE
    hi DiagnosticWarn ctermfg=173 ctermbg=235 cterm=NONE
    hi DiagnosticInfo ctermfg=39 ctermbg=235 cterm=NONE
    hi DiagnosticHint ctermfg=243 ctermbg=235 cterm=NONE
    hi DiagnosticOk ctermfg=113 ctermbg=235 cterm=NONE
    hi DiagnosticUnderlineError ctermfg=250 ctermbg=234 cterm=underline
    hi DiagnosticUnderlineWarn ctermfg=250 ctermbg=234 cterm=underline
    hi DiagnosticUnderlineInfo ctermfg=250 ctermbg=234 cterm=underline
    hi DiagnosticUnderlineHint ctermfg=250 ctermbg=234 cterm=underline
    hi DiagnosticUnderlineOk ctermfg=250 ctermbg=234 cterm=underline
    hi DiagnosticDeprecated ctermfg=250 ctermbg=234 cterm=strikethrough
    ...
    hi DiagnosticError ctermfg=160 ctermbg=255 cterm=NONE
    hi DiagnosticWarn ctermfg=166 ctermbg=255 cterm=NONE
    hi DiagnosticInfo ctermfg=26 ctermbg=255 cterm=NONE
    hi DiagnosticHint ctermfg=102 ctermbg=255 cterm=NONE
    hi DiagnosticOk ctermfg=28 ctermbg=255 cterm=NONE
    hi DiagnosticUnderlineError ctermfg=238 ctermbg=231 cterm=underline
    hi DiagnosticUnderlineWarn ctermfg=238 ctermbg=231 cterm=underline
    hi DiagnosticUnderlineInfo ctermfg=238 ctermbg=231 cterm=underline
    hi DiagnosticUnderlineHint ctermfg=238 ctermbg=231 cterm=underline
    hi DiagnosticUnderlineOk ctermfg=238 ctermbg=231 cterm=underline
    hi DiagnosticDeprecated ctermfg=238 ctermbg=231 cterm=strikethrough
