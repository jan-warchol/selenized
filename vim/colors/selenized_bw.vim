...
" Last Updated: Thu Mar  5 18:17:47 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi Constant guifg=#ed4a46 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi String guifg=#70b433 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Statement guifg=#efc541 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Identifier guifg=#eb6eb7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi PreProc guifg=#368aeb guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Special guifg=#368aeb guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Todo guifg=#efc541 guibg=#252525 guisp=NONE gui=reverse cterm=reverse
  ...
  hi Constant guifg=#d6000c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi String guifg=#1d9700 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#af8500 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Identifier guifg=#dd0f9d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#0064e4 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Special guifg=#0064e4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Todo guifg=#af8500 guibg=#ebebeb guisp=NONE gui=reverse cterm=reverse
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Todo ctermfg=178 ctermbg=235 cterm=reverse
  ...
  hi Identifier ctermfg=163 ctermbg=NONE cterm=NONE
  hi PreProc ctermfg=26 ctermbg=NONE cterm=bold
  ...
  hi Todo ctermfg=136 ctermbg=255 cterm=reverse
