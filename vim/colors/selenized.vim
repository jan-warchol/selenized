...
" Last Updated: Thu Mar  5 18:17:36 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi Constant guifg=#fa5750 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi String guifg=#75b938 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Statement guifg=#ebc13d guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Identifier guifg=#f275be guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi PreProc guifg=#4695f7 guibg=NONE guisp=NONE gui=bold cterm=bold
    hi Special guifg=#4695f7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Todo guifg=#ebc13d guibg=#184956 guisp=NONE gui=reverse cterm=reverse
  ...
  hi Constant guifg=#d2212d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi String guifg=#489100 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#a78300 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Identifier guifg=#ca4898 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#0072d4 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Special guifg=#0072d4 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Todo guifg=#a78300 guibg=#e9e4d0 guisp=NONE gui=reverse cterm=reverse
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Statement ctermfg=178 ctermbg=NONE cterm=bold
    hi Identifier ctermfg=205 ctermbg=NONE cterm=NONE
    hi PreProc ctermfg=33 ctermbg=NONE cterm=bold
    ...
    hi Todo ctermfg=178 ctermbg=238 cterm=reverse
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Todo ctermfg=LightYellow ctermbg=Black cterm=reverse
